angular.module('Yakkee')
  ...
  function vcController($http, Auth, $location) {
    ...
    // vc.startButton = document.getElementById('startButton');
    // vc.callButton = document.getElementById('callButton');
    // vc.hangupButton = document.getElementById('hangupButton');
    ...
    //
    //  vc.startTime;
    //  vc.localVideo = document.getElementById('localVideo');
    //  vc.remoteVideo = document.getElementById('remoteVideo');
